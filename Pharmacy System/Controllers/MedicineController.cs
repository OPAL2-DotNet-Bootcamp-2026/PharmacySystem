...
namespace Pharmacy_System.Controllers
{
    ...
    public class MedicineController : ControllerBase
    {
        ...
        {
            List<MedicineDto> medicines = await medicineService.GetAll();
        ...
        {
            MedicineDto? medicine = await medicineService.GetById(id);
            ...
            [FromQuery] string name)
        {
            ...
            List<MedicineDto> medicines = await medicineService.SearchByName(name);
        ...
        // Change medicine availability  /ToggleAvailability/3
