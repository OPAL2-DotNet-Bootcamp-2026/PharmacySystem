...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const pharmacyInput = document.getElementById("pharmacyId");
    ...
    form.addEventListener("submit", async (event) => {
        ...
        try {
            ...
            if (role === "Pharmacist"
                ...
                await Api.post("/Pharmacist", pharmacistData);
            }
