...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const addSupplierBtn = requiredElement("addSupplierBtn");
    const supplierModal = requiredElement("supplierModal");
    const closeModalBtn = requiredElement("closeModalBtn");
    const cancelSupplierBtn = requiredElement("cancelSupplierBtn");
    const supplierForm = requiredElement("supplierForm");
    const supplierTableBody = requiredElement("supplierTableBody");
    const supplierCount = requiredElement("supplierCount");
    const modalTitle = requiredElement("modalTitle");
    const modalDescription = requiredElement("modalDescription");
    const saveSupplierBtn = requiredElement("saveSupplierBtn");
    const successMessage = requiredElement("successMessage");
    const successTitle = requiredElement("successTitle");
    const successText = requiredElement("successText");
    const supplierNameInput = requiredElement("supplierName");
    const supplierPhoneInput = requiredElement("supplierPhone");
    const supplierEmailInput = requiredElement("supplierEmail");
    const supplierLocationInput = requiredElement("supplierLocation");
    const supplierStatusSelect = requiredElement("supplierStatus");
    let suppliers = [];
    ...
    addSupplierBtn.addEventListener("click", () => {
        ...
        setTimeout(() => supplierNameInput.focus(), 100);
    });
    ...
    function showSuccessMessage(title, message) {
        ...
        successTimer = setTimeout(() => successMessage.classList.remove("show"), 3000);
    }
